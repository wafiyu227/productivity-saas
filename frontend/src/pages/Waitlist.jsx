  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-purple-700">
      ...
      <nav className="max-w-6xl mx-auto px-8 py-6">
        <a href="/" className="text-white font-bold text-xl hover:opacity-80 transition-opacity">
          Teama AI
        </a>
      </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start max-w-5xl mx-auto">
          ...
          <div className="order-1 lg:order-2 space-y-4">
            ...
            {[
              ...
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-white hover:bg-white/20 transition-all">
      ...
      <div className="max-w-6xl mx-auto px-8 pb-20">
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 text-center text-white">
          <h3 className="text-2xl font-bold mb-4">Join forward-thinking teams</h3>
